describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('envia o formuário com sucesso usando um comando customizado 2.0 (data.)', () => {
    const data = {
      firstName: 'Duda',
      lastName: 'Teste',
  ...
  it('marca cada tipo de atendimento usando o .each()', () => {
    cy.get('input[type="radio"]')
      .each(typeOfService => {
  ...
  it('seleciona um arquivo simulando um drag-and-drop (arrasta e solta arq)', () => {
  ...
  it.only('seleciona um arquivo utilizando uma fixture para a qual foi dada um alias', () => {
    cy.fixture('example.json').as('fixtureFile')
